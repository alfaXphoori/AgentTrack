#!/bin/bash
# gemitrack - Gemini CLI wrapper with TrackCLI auto-logging
...
printf "\033[1;32m║  Gemini CLI  +  TrackCLI Auto-Logger     ║\033[0m\n"
...
while true; do
  ...
  "$TRACKCLI_BIN" auto "$QUESTION" "$ANSWER_SUMMARY" "$MODEL" $TOKENS_IN $TOKENS_OUT 2>/dev/null
