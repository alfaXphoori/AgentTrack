# Shell-GPT (sgpt) Integration for TrackCLI

Shell-GPT (`sgpt`) is a powerful CLI for interacting with ChatGPT. You can create a custom role to instruct Shell-GPT to run the TrackCLI logging command.
...
trackcli auto "your prompt here" "your summary here" "sgpt" 0 0
```
...
```bash
sgpt --role trackcli "Refactor the authentication logic"
```
