# Roo Code Integration for AgentTrack

[Roo Code](https://roocode.com/) (formerly Roo Cline) is an advanced AI coding assistant that uses "Rules as Code."

## Setup

Roo Code allows for detailed rule structures. To integrate AgentTrack, you can define a workspace rule.
...
`atrack auto "<user_question>" "<ai_summary>" "roo-code" 0 0`
