# Aider Integration for TrackCLI

Aider is a popular AI pair programming tool in the terminal. To ensure Aider automatically logs its interactions using TrackCLI, you can define project-specific conventions.
...
`trackcli auto "<user_question>" "<ai_summary>" "aider" 0 0`
